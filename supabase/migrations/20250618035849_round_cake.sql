...
-- Grant permissions for frontend anon access
GRANT SELECT, INSERT, UPDATE, DELETE ON auth_users TO anon;
GRANT SELECT, INSERT, UPDATE, DELETE ON campus_mantris TO anon;
